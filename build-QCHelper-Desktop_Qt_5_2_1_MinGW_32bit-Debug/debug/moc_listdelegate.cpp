/****************************************************************************
** Meta object code from reading C++ file 'listdelegate.h'
**
...
#include "../../QCHelper/listdelegate.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'listdelegate.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ListDelegate_t, stringdata) + ofs \
...
const QMetaObject ListDelegate::staticMetaObject = {
    { &QAbstractItemDelegate::staticMetaObject, qt_meta_stringdata_ListDelegate.data,
      qt_meta_data_ListDelegate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ListDelegate.stringdata))
        return static_cast<void*>(const_cast< ListDelegate*>(this));
